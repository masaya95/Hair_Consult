...
<div class="container">
  <div class="row">
    ...
    <!-- main -->
    <div class="col-md-8">
      <div class="custom-main-var rounded bg-primary text-center text-nowrap"><div class="box-center text-white font-weight text-nowrap">検索結果一覧</div></div>
        ...
        @foreach($items as $item)
          ...
          <div class="card custom-card">
            <div class="card-header">
              <span class="rounded bg-warning category-icon">{{ $item->category }}</span>
            </div>
            <div class="card-body">
              <h4 class="card-title">
